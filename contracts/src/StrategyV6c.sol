...
/// @title V6c - Baseline + only change: symmetric fee 26 instead of 28
contract Strategy is AMMStrategyBase {
    ...
    function afterSwap(TradeInfo calldata trade) external override returns (uint256 bidFee, uint256 askFee) {
        ...
        // CHANGE: symmetric fee 26 instead of 28
        if (devBps < 8) { bidFee = bpsToWad(26); askFee = bpsToWad(26); }
    ...
    function getName() external pure override returns (string memory) { return "V6c"; }
}
