...
/// @title V25 - Fixed gamma correction (25 bps) for pHat + direction-adaptive alpha
/// @notice Uses a fixed 25 bps gamma for pHat correction instead of the actual fee.
///         This makes pHat estimation completely independent of the fee structure,
///         eliminating direction-dependent bias entirely.
///         Combined with direction-adaptive alpha (28/22) from V13.
contract Strategy is AMMStrategyBase {
    ...
    function afterSwap(TradeInfo calldata trade) external override returns (uint256 bidFee, uint256 askFee) {
        ...
        // CORE CHANGE: Fixed gamma at 25 bps for pHat correction
        // This eliminates ALL fee-dependent bias in pHat
    ...
    function getName() external pure override returns (string memory) { return "OptV25"; }
}
