...
/// @title V6e - Baseline + only change: same-step EMA 2% instead of 1%
contract Strategy is AMMStrategyBase {
    ...
    function afterSwap(TradeInfo calldata trade) external override returns (uint256 bidFee, uint256 askFee) {
        ...
        if (gamma != 0) {
            ...
            // CHANGE: 2% same-step EMA instead of 1%
    ...
    function getName() external pure override returns (string memory) { return "V6e"; }
}
